    ...
    public class ProxyTester
    {
        ...
        private async Task<ProxyTestResult> TryRequestAsync(string url, string? proxyAddress, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                using var client = !string.IsNullOrWhiteSpace(proxyAddress) ?  (proxyAddress.StartsWith("socks5://") ? CommonHelper.CreateSocks5HttpClient(proxyAddress) : CommonHelper.CreateProxyHttpClient(proxyAddress)) : new HttpClient() ;
